Feature('@first Create Tasks @step:06 @smoke @story:12345 @S66d5554c')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item @T902f9bb7', async ({ I, TodosPage }) => {
...
Scenario('Create ouch another new todo item @T55fb5028', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('No todo @Tb11e85ca', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Create another one plus new todo item @Tf71eba56', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Create multiple todo items @T619bcc86', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters @T3104552e', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item @Tf8518966', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed @T86c3b1b2', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list @T222edbb8', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs @T5f6f3ab6', async ({ I, TodosPage }) => {
