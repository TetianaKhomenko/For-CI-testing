Feature('Mark as completed/not completed @step-06 @Se1ad27c9')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed @T134634ad', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos @T90890f46', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed @T8eb498ed', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos @Tb92a7c44', async ({ I, TodosPage }) => {
